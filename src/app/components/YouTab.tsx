...
export default function YouTab() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="hidden bg-white bg-green-100 text-green-800 bg-blue-100 text-blue-800 bg-yellow-100 text-yellow-800 bg-orange-100 text-orange-800 bg-gray-100 text-gray-700 bg-red-100 text-red-800 bg-green-100 text-green-800 bg-blue-100 text-blue-800 bg-purple-100 text-purple-800 bg-gray-100 text-gray-700 bg-blue-100 text-blue-800 bg-purple-100 text-purple-800 bg-pink-100 text-pink-800 bg-indigo-100 text-indigo-800 bg-orange-100 text-orange-800 bg-teal-100 text-teal-800 bg-red-100 text-red-800 bg-yellow-100 text-yellow-800 bg-blue-100 text-blue-800 bg-purple-100 text-purple-800 bg-indigo-100 text-indigo-800 bg-teal-100 text-teal-800 bg-orange-100 text-orange-800 bg-pink-100 text-pink-800 bg-green-100 text-green-800 bg-red-100 text-red-800 bg-yellow-100 text-yellow-800 bg-emerald-100 text-emerald-800 bg-gray-100 text-gray-800 bg-blue-100 text-blue-800 bg-purple-100 text-purple-800 bg-pink-100 text-pink-800 bg-indigo-100 text-indigo-800 bg-orange-100 text-orange-800 bg-teal-100 text-teal-800 bg-red-100 text-red-800 bg-yellow-100 text-yellow-800 bg-green-500 text-white bg-green-400 text-white bg-green-300 text-gray-800 bg-green-200 text-gray-700 bg-gray-200 text-gray-700 bg-gray-100 text-gray-600 border-green-100 border-blue-100 border-yellow-100 border-orange-100 border-gray-100"></div>
    </div>
  );
} 